	...
	return (
		<View style={[login_style.wrp_main, {flex: 1}]}>
			<View style={[temp_style.textMsg]}>
				<Text style={[txt.noto30, {color: GRAY10}]}>발급받은 코드를 입력해주세요.</Text>
			</View>
			...
			<View style={[btn_style.queryBtn, shelterCodeCheck_style.queryBtn]}>
				...
				<TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}} onPress={onInquery}>
					<Text style={[txt.noto28]}>문의하기 </Text>
					<NextMark />
				</TouchableOpacity>
			</View>
			...
			<View style={[btn_style.btn_w654, shelterCodeCheck_style.btn_w654]}>
				{confirmed ? (
					...
					<AniButton btnTitle={'다음'} btnLayout={btn_w654} disable titleFontStyle={32} onPress={goToNextStep} />
				)}
			</View>
		</View>
	);
