export const dummy_ActivationList = [
	{
		title: '임시보호 참여하기',
		content:
			'임시보호를 참여하기 위해서는 어떤 것부터 해야 할까? 의욕만 가지고 시작하기에는 너무 먼 임시보호..ㅠ 지식 쌓기부터 시작하는 임시보호 참여하기! 함께 그 방법을 알아볼까요??',
		image: 'https://t1.daumcdn.net/cafeattach/1YMOi/6a29e54280110d61d2fee57dc946518b5b712af9',
		like_count: 1121,
	},
	{
		title: '반려동물 실종시 전단지 만들기',
		content: '반려동물 실종! 당황하기에 앞서 빠른 조치가 우선입니다! 애니로그가 사용자님의 실종 반려동물 찾기에 적극 동참하겠습니다.',
		image: 'https://www.korea.kr/newsWeb/resources/attaches/2018.08/13/j(10)(1).jpg',
		like_count: 1121,
	},
	{
		title: '임시보호 가이드 댕댕이 편',
		content: '임시보호에 참여하기에 앞서 반드시 숙지해야 하는 지식 리스트! 함께 알아봅시다',
	...
	{
		title: '입양하기',
		content: '무엇인가 멀기만 한 반려동물 입양. 애니로그와 함께 입양의 하나부터 열까지 알아보도록 합시다.',
		image:
...
export const dummy_MissingReportList = [
	{
		...
		missing_animal_features: '실시간 영어로 번역해서 말함', //실종 동물의 특징
	},
	{
		//임시로 지정
		...
		missing_animal_features: '3개국어를 알아들음', //실종 동물의 특징
	},
	{
		//임시로 지정
	...
	},
	{
		...
		missing_animal_features: '자주 새를 사냥해 옴', //실종 동물의 특징
	},
	{
		//임시로 지정
