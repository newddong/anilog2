...
import {Text, View, StyleSheet, TouchableOpacity, TouchableWithoutFeedback, Keyboard, ActivityIndicator} from 'react-native';
...
export default SendHeader = ({route, navigation, options}) => {
	...
	return (
		<View style={[style.headerContainer, style.shadow]}>
			...
			{sent ? <ActivityIndicator size="small" color={'black'} /> : <Send60_Big onPress={onSend} />}
		</View>
	);
};
