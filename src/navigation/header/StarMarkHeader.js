...
import {BackArrow32, Location54_Filled, Star60_Filled, Star60_Border} from 'Atom/icon';
import DP from 'Root/config/dp';
import {WHITE, APRI10} from 'Root/config/color';
import {txt} from 'Root/config/textstyle';

export default StarMarkHeader = ({navigation, route, options, back}) => {
	...
	return (
		<View style={[style.headerContainer, style.shadow]}>
			...
			{isTagged ? <Star60_Filled onPress={toggleTag} /> : <Star60_Border onPress={toggleTag} />}
		</View>
	);
};
